...
Full-Stack developer well-versed in JavaScript/Typescript (React.js, Next.js, Vue.js, Angular, Node.js, Web3.js, Ethers.js, Solana.js, AWS), Blockchain(Ethereum, Bitcoin, Solidity, Rust, DeFi, NFT, DAO, Vault, P2E etc).
